...
export default function MagBody(props) {
  const { MagBody, overrides: overridesProp, ...rest } = props;
    ...
    >
      ...
      >
        <View
          ...
          right="0%"
          padding="0px 0px 0px 0px"
          backgroundColor={MagBody?.tag_color}
